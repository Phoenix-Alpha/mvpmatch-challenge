...
export interface IMenuIcon1Props {
  width?: number
  height?: number
  className?: string
}

export const MenuIcon1: FC<IMenuIcon1Props> = memo(
  ({ width = 24, height = 24, className = '' }: IMenuIcon1Props) => (
    <svg
      width={width}
      height={height}
      viewBox='0 0 24 24'
...
MenuIcon1.displayName = 'MenuIcon1'
