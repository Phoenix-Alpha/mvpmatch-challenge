...
export interface IMenuIcon4Props {
  width?: number
  height?: number
  className?: string
}

export const MenuIcon4: FC<IMenuIcon4Props> = memo(
  ({ width = 25, height = 25, className = '' }: IMenuIcon4Props) => (
    <svg
      width={width}
      height={height}
      viewBox='0 0 25 25'
...
MenuIcon4.displayName = 'MenuIcon4'

export default MenuIcon4
