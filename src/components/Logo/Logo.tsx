...
export const Logo: FC<ILogoProps> = memo(
  ({ width = 27, height = 40, className = '' }: ILogoProps) => (
    <svg
      width={width}
      height={height}
      viewBox='0 0 27 40'
    ...
    >
      <g clipPath='url(#clip0_36_5190)'>
        <path
          ...
          fill='url(#paint0_linear_36_5190)'
        />
        <path
          d='M6.89306 14.568H0V39.9616H6.89306V14.568Z'
          fill='url(#paint1_linear_36_5190)'
        />
        <path
          ...
          fill='url(#paint2_linear_36_5190)'
        />
      </g>
      <defs>
        <linearGradient
          id='paint0_linear_36_5190'
          x1='19.2816'
          y1='20.596'
          x2='10.9532'
          y2='43.4265'
